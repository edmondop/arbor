...
pub(crate) const DIFF_COMMENT_BG: u32 = 0x2a3040;
pub(crate) const DIFF_COMMENT_RESOLVED_BG: u32 = 0x222830;
...
pub(crate) const DIFF_COMMENT_ICON: &str = "\u{f075}"; // nf-fa-comment
